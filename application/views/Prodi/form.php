					...
					<div class="mb-3">
						...
						<select
							...
							<?php foreach ($fakultas as $item): ?>
								...
								<option
									value="<?php echo $item['fakultas_id']; ?>"
									<?php echo set_select(
										'fakultas_id',
										$item['fakultas_id'],
										isset($prodi['fakultas_id']) && $prodi['fakultas_id'] == $item['fakultas_id']
									); ?>>

									<?php echo $item['fakultas_name']; ?>
						...
						<div class="form-check form-check-inline">
							<input
								...
								<?php echo set_radio(
									'prodi_strata',
									'D3',
									isset($prodi['prodi_strata']) && $prodi['prodi_strata'] === 'D3'
								); ?>>
						...
						<div class="form-check form-check-inline">
							<input
								...
								<?php echo set_radio(
									'prodi_strata',
									'S1',
									isset($prodi['prodi_strata']) && $prodi['prodi_strata'] === 'S1'
								); ?>>
						...
						<div class="form-check form-check-inline">
							<input
								...
								<?php echo set_radio(
									'prodi_strata',
									'S2',
									isset($prodi['prodi_strata']) && $prodi['prodi_strata'] === 'S2'
								); ?>>
